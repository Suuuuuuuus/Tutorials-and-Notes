...
basicstyle=\ttm\normalsize,
tabsize=4,
morekeywords={self, head, tail, uniq, sort, grep, cat, cut, echo, wc, cp, rm, mkdir, cd, nano, man, ls, history, bash, rmdir, find, plink, bcftools, bedtools, octopus, sacct, snakemake, column, df, sbatch, squeue, scancel, sstat, sprio, srun},              % Add keywords here
